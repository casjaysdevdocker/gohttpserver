...
# @@File             :  entrypoint.sh
# @@Description      :  entrypoint point for gohttpserver
...
__heath_check() {
  ...
  start-gohttpserver.sh healthcheck || status=$((status + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-gohttpserver}"
